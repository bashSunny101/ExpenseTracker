    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex-grow flex justify-center items-center">
        <div className="p-4">
          ...
          <div className="mb-4">
            <label htmlFor="amount" className="block font-semibold text-black">
              Amount:
            </label>
            <input
              type="number"
          ...
          <button onClick={addExpense} className="bg-blue-500 p-2 rounded">
            Add Expense
          </button>
        </div>
      </div>
      ...
      <div className="p-4">
        ...
        <p className="text-black">${calculateTotal()}</p>
      </div>
    </div>
  );
}
